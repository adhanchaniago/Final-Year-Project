    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content"> 
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-4">Printing Vendor</h2>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">List of Vendor</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-user-cog mr-2"></i>List of Printing Vendor
                                <button type="button" name="add" id="add" class="btn btn-primary btn-sm add" style="margin-left:60%;"><i class="fas fa-user-plus mr-1"></i>Add</button>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="VendorList" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Vendor Name</th>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><b>Edit Printing Vendor Account</b></h4>
        ...
        <div id="modalDelete" class="modal fade">
            <div class="modal-dialog"> 
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><b>Delete Vendor Account</b></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <script src="dist/assets/demo/ListVendor.js"></script>
    </body>
</html>
