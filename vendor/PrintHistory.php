...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content"> 
                <main>
                    <div class="container-fluid">
                        <h2 class="mt-4">Print History</h2>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Print History</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-2"></i>List of Printing History
                            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="export" style="margin-left:68%"><i class="fas fa-download mr-1"></i> Export Table</a>
                            </div>
                            <div class="card-body">
        ...
        <script src="dist/assets/demo/PrintHistory.js"></script>
