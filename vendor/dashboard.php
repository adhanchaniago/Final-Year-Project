                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-4">
                                <div class="card bg-danger text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a><?php echo $total_pending;?></a>
                                        <div class="small text-white">
                                        <i class="fas fa-clipboard-list fa-2x"></i></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-4">
                                <div class="card bg-info text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a><?php echo $total_complete;?></a>
                                        <div class="small text-white">
                                        <i class="fas fa-calendar-check fa-2x"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body"><canvas id="myBarChart" width="100%" height="230"></canvas></div>
