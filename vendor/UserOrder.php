...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <!-- Modal Popup for button Proceed -->
        <div id="modalproceed" class="modal fade">
            <div class="modal-dialog"> 
                <form id="recordForm" style="margin:50px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title"><b>Customer Pending Order</b></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <table  id="proceedtable">
                        ...
                        <td>
                        <div class="form-group">
                            <label class="control-label">Already complete print this document?</label></br>     
                        </div>
                        </td>
                        </tr>
                    </table>
